...
```
- Now you need to make one change to create the latest version of the R1CBU/R2RFE firmware, currently `V0.33.2` (ugly workaround..).
```
sed -i "s,^X6100_GUI_VERSION = v0.23.0-rc.3,X6100_GUI_VERSION = v0.33.2,g" AetherX6100Buildroot/br2_external/package/x6100-gui/x6100_gui.mk
```
> [!NOTE]
For future versions, you will need to adjust the command instead of  
_sed -i "s,^X6100_GUI_VERSION = v0.23.0-rc.3,X6100_GUI_VERSION = `v0.33.2`,g" AetherX6100Buildroot/br2_external/package/x6100-gui/x6100_gui.mk_  
use  
...
```
cd ../..
sed -i "s,^X6100_GUI_VERSION = v0.33.2,X6100_GUI_VERSION = v0.23.0-rc.3,g" AetherX6100Buildroot/br2_external/package/x6100-gui/x6100_gui.mk
```
